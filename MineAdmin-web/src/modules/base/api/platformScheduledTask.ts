...
export type ScheduledTaskType = 'url' | 'script' | 'method' | 'backup'
...
export function run(id: number): Promise<ResponseStruct<ScheduledTaskLogVo>> {
  return useHttp().post(`/admin/platform/scheduled-task/${id}/run`)
}
