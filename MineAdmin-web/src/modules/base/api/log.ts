...
import type { OperationParams } from '@/generated/admin-api'

export interface UserLoginVo extends Partial<Omit<OperationParams<'adminUserLoginLogList'>, 'status'>> {
  id: number // 主键
  username: string
  ip: string
  os: string
...
export interface RequestLogInfoVo extends Partial<OperationParams<'adminUserOperationLogList'>> {
  // 主键
  id: number
  // 用户名
  username: string
